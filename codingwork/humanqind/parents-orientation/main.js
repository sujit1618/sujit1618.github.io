...
let hour;
let minutes;
let session=['https://youtu.be/2StYT58YxCc','https://youtu.be/ssLyfHbxEa8','https://youtu.be/OP2YPug5V-M','https://youtu.be/nhdkG3aYlcQ','sesh5'];
...
function openSession() {
    window.open('https://youtu.be/KEzRMA94g3E');
}